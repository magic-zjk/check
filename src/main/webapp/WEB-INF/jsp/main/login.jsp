...
<link rel="shortcut icon" type="image/x-icon" href="static/img/jingfeng_logo.png" media="screen" />
...
<body>
	...
	<div class="container_wapper">
		<div>
			<img alt="" src="static/login/images/banner_slide_01.jpg" style="position:absolute; width:100%; height:100%; z-index:-1;">
		</div>
	...
	<script type="text/javascript">
		...
		function severCheck(){
			if(check()){
				...
				var code = $("#code").val();
				var rememberMe = $("#saveid").prop("checked");
				var data = {
						userName : loginname,
						password : password,
						code : code,
				...
				$.ajax({
					...
					success: function(data){
						if("success" == data.result){
							...
							$("#loginname").focus();
						}else if("codeexpired" == data.result){
							$("#code").tips({
								side : 1,
								msg : "验证码过期，请点击验证码图片或者刷新页面重新获取",
								bg : '#FF5080',
								time : 15
							});
							$("#code").focus();
		...
		function changeCode() {
			$("#codeImg").attr("src", "secucode?t=" + genTimestamp());
		}
