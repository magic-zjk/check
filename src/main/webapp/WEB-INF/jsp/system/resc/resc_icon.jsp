...
<html lang="en">
	...
	<body>
		<form action="resc/doEditIcon" name="rescForm" id="rescForm" method="post">
			<input type="hidden" name="rescId" id="rescId" value="${rescId}"/>
			<input type="hidden" name="rescIcon" id="rescIcon" value=""/>
			<div id="zhongxin">
