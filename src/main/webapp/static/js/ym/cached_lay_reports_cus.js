	...
	return {
		...
		init : function(target,options){
			...
			var defaults = {
				...
				panelTempl : '<div class="filterpanel" style="display:none;"><input type="text" class="input" placeholder="'+I18n.t('components.search.name')+'"/><ul class="filterlist"></ul><div class="load" style="margin:10px auto;text-align:center;display:block;"><img src="static/images/pic/ajax-loader.gif"/></div><div class="submitpanel"><a href="#" class="submit">'+I18n.t('components.buttons.confirm')+'</a></div></div>'
			};
			var settings = $.extend({},defaults,options);
  ...
  $.fn.ProSelect = function(options) {
    if (this.length > 0) {
      ...
      var defaults = {
        ...
        tempid: 'proTemp',
        inputname: [I18n.t('components.filters.time_unit.last_60_day'), I18n.t('components.filters.time_unit.last_30_day'), I18n.t('components.filters.time_unit.last_7_day'), I18n.t('components.filters.time_unit.today')],
        inputval: ['-60','-30','-7','-1'],
        custom: true,
        callback: '',
...
var Contrast = function(){
    ...
    this.bindSubmit = function(settings){
        settings.panel.find('.submit').unbind('click').bind('click',function(){
            ...
            //$('#'+settings.contrastTo).after('<div class="loadingChart"><img src="static/images/pic/ajax-loader.gif" /></div>');
...
//            }
//            if (settings.data == '') {
//                loading_icon.html('<img src="static/images/pic/ajax-loader.gif" />').show();
//
//                $.ajax({
//                    url: settings.url,
...
//                                                    $.publish('tableRenderPaginationCallback', [inst, data]);
    ...
    */
    $.fn.animatable = function(options) {
        return this.each(function() {
            ...
            origin.addClass('fl').width(w1).wrap("<div class='pannelshow'></div>").wrap("<div class='pannel clearfix'></div>");
            ...
            pannel.parent().css({'overflow': 'hidden', 'width': '100%'});

            origin.animate({ marginLeft: '-' + w1 }, 'slow', function() {
                ...
                settings.switch_to.find('.back').unbind('click').bind('click', function() {
                    ...
                    origin.animate({ marginLeft: 0 }, 'slow', function() {
...
//                },
           ...
           var currentChartOptions = $.extend(true,{},{
                   ...
                   xAxis: {
                     ...
                     labels:{
                         ...
                         formatter:function(){
                             //this.value
                             var d = String(this.value).split(' ')[0].split('-');
                             if(d.length == 3){
                                 return d[1] + '-' + d[2];
                             }else{
                                 return this.value;
       ...
       renderCompareChart: function(options){
           ...
           try{
               ...
               this.element.after('<div class="loadingChart"><img src="static/images/pic/ajax-loader.gif" /></div>');
               $.ajax({
                   type: 'get',
                   url: u,
...
;(function($,U){
    ...
    Template.prototype.temps = {
        plugin:{
            chartLoading: '<div class="load-chart"><p><img src="static/images/pic/ajax-loader.gif"></p></div>',
...
$.fn._export = function(e,options){
    ...
    function getCsv(tar){
        ...
        var defaults = {
            ...
            downloadCenterUrl: '/apps/download_center',
            stats: action
        }
    ...
    function callbackFunc(e,data,params){
        var right = e.offsetX+35 +'px';
        var top = e.offsetY+20+'px';
        if(data.result == 'success'){
            inst.removeClass('export-icon-load');
            inst.after('<div class="tip-export"><div class="small-corner"></div><a class="fr close font-highlight"><b class="icon icon-close"></b></a>'+I18n.t('page_misc.download_center.redirect_link', {'aleft':'<a href='+ params.downloadCenterUrl +' class="font-highlight close">', 'aright':'</a>'})+'&nbsp;</div>');
            setTimeout(function(){
...
;(function($) {
  $.widget('umeng.multiSelector', {
    ...
    templatePicker: '<div class="multi-selector-options"> \
      <div class="loading-tip" ><img src="static/images/pic/ajax-loader.gif"></div> \
      </div> \
