            ...
            table:[
                {
                    ...
                    tmpl: '<tr><td>${date}</td><td>${install}</td><td>${install_uniq}</td><td>${active}</td><td>${active_uniq}</td><td>${launch}</td><td>${install_accum}</td></tr>',
                    per_page: 30,
                    params: {
                        app_tag_id: $('#group-select-cus').DownList('get').attr('data-id')
                    }
            ...
            chart: [
                {
                    ...
                    chartParams: {
                        tooltip: {
                            formatter: function() {
                                return '' + this.key + ': ' + this.y + (tab_VM.getTab().indexOf('rate') > 0 ? '%' : '');
                            }
                        }
                    },
                    callback:function(){
            ...
            table: [
                {
                    ...
                    tmpl:'<tr><td>${date}</td><td>${payments}</td><td>${payers}</td><td>${paynumber}</td></tr>',
                    params: {
