...
$(function(){if('map'== locat[3]){locat =  locat[0]+'//'+locat[2];}else{locat =  locat[0]+'//'+locat[2]+'/'+locat[3];};});
...
function openMap(){
   var result = showModalDialog(locat+"/map/mapXY.do","","dialogWidth=650px;dialogHeight=500px;");
