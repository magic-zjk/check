...
//oTable.width()=1145.4,oDiv.width()=1043,oTable.height()=879.8,oDiv.height()=1024
	...
	//oTable.height()=879.8,oDiv.height()=1024	
	...
	//oTable.width()=1145.4,oDiv.width()=1043
	...
	for(var i=iRowStart;i<iRowEnd;i++){
		...
		if(colNumber!=0){
			...
			for(var j=0; j<colNumber;j++){
				...
				newTd.height(oidTd.height()+0.18);
				newTd.width(oidTd.outerWidth(true));
				jWidth += oidTd.outerWidth(true);
